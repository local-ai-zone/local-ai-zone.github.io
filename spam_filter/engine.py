...
class SpamFilterEngine:
    ...
    def _convert_to_expected_format(self, raw_model: Dict, gguf_file: Dict) -> Optional[Dict]:
        ...
        try:
            ...
            model_capability = self._detect_model_capability(model_id, model_name, raw_model.get('tags', []))
    ...
    def _detect_model_capability(self, model_id: str, model_name: str, tags: List[str]) -> str:
